...
\begin{center}
	...
	\end{subfigure}
	\captionfonts
	\caption{Limiting the search region reduces false positive matches.~\cite{sadParallel}.}%The SAD between a reference window and several candidate windows~\cite{sadParallel}.}
	\label{fig:sadGraphs}
\end{center}
\end{figure}
