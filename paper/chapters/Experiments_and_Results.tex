...
~\Cref{eq:a,eq:b,eq:c,eq:d,eq:e,eq:f,eq:g} are the parameters for the rest of the equations. ~\Cref{eq:h} gives the height of the disparity map image. The width of the disparity map image, ~\Cref{eq:j}, needs to be divisible by ~\Cref{eq:e}, so ~\Cref{eq:i} is used to reduce it. The number of pixels in the disparity map image is calculated in ~\Cref{eq:k}. The base number of iterations, ~\Cref{eq:l}, is the minimum number of iterations required to create the disparity map. Additional iterations, ~\Cref{eq:n}, occur from the SAD algorithm proceeding through the images in the form of columns, top to bottom, left to right. There are a certain amount of iterations at the top of each column that are not used because enough of the rows must be loaded in order to obtain the disparity values. ~\Cref{eq:o} is the total number of iterations needed to process the pair of images. ~\Cref{eq:p} is the number of cycles for the SAD algorithms. ~\Cref{eq:q} is the number of cycles for the minimum comparators. ~\Cref{eq:r} are the extra cycles that occur from syncing up the data. ~\Cref{eq:s} is the total number of cycles for the entire pair of images to be processed.
...
\begin{align}
	...
	extraCyc = 52,824 &= totIters * 2 \label{eq:r}\\
	totClkCyc = 2,306,168 &= sadTotCyc + minTotCyc + extraCyc \label{eq:s}
\end{align}
...
\begin{table}
	\begin{center}
		\begin{tabu}{| p{1.8cm} | p{2cm} | p{1,7cm} | p{1.7cm} | p{1.7cm} | p{1.5cm} | p{1.6cm} |}
			...
			\\ \hline 
			288 x 384 & 280 x 360 & 9x9 & 2,124,784 & 129,560 & 51,824 & 2,306,168
			\\ \hline 
			288 x 384 & 282 x 362 & 7x7 & 416,976 & 260,610 & 521,220 & 1,198,806
			\\ \hline 
			288 x 384 & 282 x 360 & \specialcell{7x7\\(4 pix //)} & 1,295,700 & 129,570 & 51,828 & 1,477,098
			\\ \tabucline[2pt]{-} 
			
			383 x 434 & 375 x 408 & 9x9 & 3,202,756 & 195,290 & 78,116 & 3,476,162
			\\ \hline 
			383 x 434 & 377 x 412 & 7x7 & 631,136 & 394,460 & 788,920 & 1,814,516
			\\ \hline 
			383 x 434 & 377 x 412 & \specialcell{7x7\\(4 pix //)} & 1,972,150 & 197,215 & 78,886 & 2,248,251
			\\ \tabucline[2pt]{-}
			
			480 x 640 & 472 x 616 & 9x9 & 6,060,784 & 369,550 & 147,824 & 6,578,168
			\\ \hline 
			480 x 640 & 474 x 618 & 7x7 & 1,186,512 & 741,570 & 1,483,140 & 3,411,222
			\\ \hline 
			480 x 640 & 474 x 616 & \specialcell{7x7\\(4 pix //)} & 3,695,700 & 369,570 & 147,828 & 4,213,098
			\\ \hline
		\end{tabu}	
		\captionfonts
...
\begin{table}
	\begin{center}
		\begin{tabu}{| p{1.8cm} | p{2cm} | p{2cm} | p{2cm} | p{2cm} | p{2cm} |}
			...
			\\ \hline 
			9x9 & 2,306,168 & 0.04804 & 0.02306 & 20.82 & 43.36
			\\ \hline 
			7x7 & 1,198,806 & 0.02497 & 0.01199 & 40.05 & 83.42
			\\ \hline 
			\specialcell{7x7\\(4 pix //)} & 1,477,098 & 0.03077 & 0.0148 & 32.50 & 67.70
			\\ \tabucline[2pt]{-} 
			
			9x9 & 3,476,162 & 0.07241 & 0.03476 & 13.81 & 28.77
			\\ \hline 
			7x7 & 1,814,516 & 0.03780 & 0.01815 & 26.46 & 55.11
			\\ \hline 
			\specialcell{7x7\\(4 pix //)} & 2,248,251 & 0.04683 & 0.02248 & 21.35 & 44.48
			\\ \tabucline[2pt]{-}
			
			9x9 & 6,578,168 & 0.1370 & 0.06578 & 7.298 & 15.20
			\\ \hline 
			7x7 & 3,411,222 & 0.06578 & 0.03411 & 15.20 & 29.32
			\\ \hline 
			\specialcell{7x7\\(4 pix //)} & 4,213,098 & 0.08776 & 0.04213 & 11.39 & 23.74
			\\ \hline
		\end{tabu}	
		\captionfonts
